void PointTurn(float point_x, float point_y, float w_degrees, char type_move, float speed_up_part = 0.5, float speed = min_speed_const, float accel = acceleration)
{
...
void TankTurnPizdecFast(float w_degrees, float speed_up_part = 0.5, float speed = min_speed_const)
{
	PointTurn(0, 0, -1 * w_degrees, 1, speed_up_part, speed, acceleration_turnSuperPizdecFast);
}
